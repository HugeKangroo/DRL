...
- 由于不是均匀采样，数据的分布发生了改变。这种改变可能导致学习的网络或者函数的学习是有偏的
  - 更新的分布必须和期望的分布相同，而实际Double的网络中，目标网络也发生了更新。
  - 目标网络的改变(更新)
...
$$
\nabla_{\theta_i}L_i(\theta_i) = \mathbb{E}_{s,a,r,s' \sim \mathcal P(\mathcal D)}[(r+\gamma \max_{a}Q(s',a';\theta^{-})-Q(s,a;\theta_i)) \nabla_{\theta_i}Q(s,a;\theta_I)]
$$
